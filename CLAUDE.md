...
- Version in `app/build.gradle.kts`: `versionName` (semver), `versionCode` (monotonic semver delta from production baseline 1,778,932,594: `BASE + (semver - BASE_SEMVER) + buildNumber`)
